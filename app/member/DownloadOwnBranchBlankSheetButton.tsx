...
import BlankCollectionSheetDocument from "@/app/main-admin/branches/[id]/BlankCollectionSheetDocument";
import { generateMemberOwnBranchBlankSheet } from "@/app/main-admin/branches/[id]/blank-sheet-actions";

export default function DownloadOwnBranchBlankSheetButton() {
  ...
  function handleClick() {
    ...
    startGenerating(() => {
      void (async () => {
        try {
          const sheet = await generateMemberOwnBranchBlankSheet();

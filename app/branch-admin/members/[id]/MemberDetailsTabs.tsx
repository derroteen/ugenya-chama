...
type TabKey = "family" | "beneficiary" | "contributions";
      ...
      <div className="px-4 py-6 sm:px-6 sm:py-8">
        ...
        {activeTab === "contributions" ? (
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
            <h2 className="text-xl font-semibold text-[#0f1729]">Contributions</h2>
            <p className="mt-3 text-slate-600">Contribution recording will appear here.</p>
            <div className="mt-5 flex flex-wrap gap-3">
              <a
                href="#"
                className="inline-flex items-center rounded-lg bg-[#1d3a8a] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#16306f]"
              >
                Record Monthly Contribution
              </a>
              <a
                href="#"
                className="inline-flex items-center rounded-lg border border-[#1d3a8a] bg-white px-4 py-2 text-sm font-semibold text-[#1d3a8a] transition hover:bg-slate-100"
              >
                Record Funeral Contribution
              </a>
            </div>
          </div>
        ) : null}
